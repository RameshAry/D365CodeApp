 ...
 */
export type ContactCreatePayload = Partial<ContactsBase> & {
...
export const Contactsvs_ethnicitytype = {
  717770000: 'Aboriginal',
  717770001: 'TorresStraitIslander',
  717770002: 'AboriginalandTorresStraitIslander',
  717770003: 'Donotidentify',
  717770004: 'Donotwishtodisclose'
} as const;
export type Contactsvs_ethnicitytype = keyof typeof Contactsvs_ethnicitytype;
export const Contactsvs_hearaboutus = {
  717770010: 'AustralianDefenceForce',
  717770003: 'NewsWebsite',
  717770004: 'Newspaper_Magazine',
  717770008: 'OnlineAdvertising',
  717770000: 'RSLorMates4MatesWebsite',
  717770005: 'Referral',
  717770007: 'SearchEngine_Google_Bingetc_',
  717770006: 'SocialMedia',
  717770002: 'TV',
  717770001: 'WordofMouth',
  717770009: 'Other'
} as const;
export type Contactsvs_hearaboutus = keyof typeof Contactsvs_hearaboutus;
...
export interface ContactsBase {
  ...
  vs_ethnicitytype?: Contactsvs_ethnicitytype;
  vs_hearaboutus?: Contactsvs_hearaboutus;
  websiteurl?: string;
...
export interface Contacts extends ContactsBase {
  ...
  vs_ethnicitytypename?: string;
  vs_hearaboutusname?: string;
  yomifullname?: string;
  accountid?: object;
