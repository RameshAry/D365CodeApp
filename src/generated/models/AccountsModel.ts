...
export interface AccountsBase {
  ...
  vs_centrecode?: string;
  vs_primaryorganisationcode?: string;
  vs_referralcode?: string;
  "vs_State@odata.bind"?: string;
  "vs_wellbeingcentre@odata.bind"?: string;
  websiteurl?: string;
  yominame?: string;
}
...
export interface Accounts extends AccountsBase {
  ...
  vs_statename?: string;
  vs_wellbeingcentrename?: string;
  vs_wellbeingcentreyominame?: string;
  createdby?: object;
  ...
  vs_state?: object;
  _vs_state_value?: string;
  vs_wellbeingcentre?: object;
  _vs_wellbeingcentre_value?: string;
}